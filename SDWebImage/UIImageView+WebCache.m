 ...
 *  @return imageview
 */
+ (UIImageView *)createGeneralImageView
{
    
    UIImageView   *generalImageView = [[UIImageView alloc] init];
    generalImageView.contentMode = UIViewContentModeScaleAspectFit;
   // generalImageView.backgroundColor = [UIColor getColor:@"f1f1f1"];
    [generalImageView setContentScaleFactor:[[UIScreen mainScreen] scale]];
 //   generalImageView.image = [UIImage imageNamed:@"app_load_200x200"];
    generalImageView.backgroundColor = [UIColor whiteColor];
    return generalImageView;
